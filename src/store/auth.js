...
export default {
    ...
    actions: {
        async addNewUser ({ commit, state }, payload) {
            try {
                const { data } = await axios.post (
                    `https://vue-js-project-9795a-default-rtdb.firebaseio.com/user.json?auth=${state.token}`, payload
                );
        ...
        async getRegisterData ({ commit, dispatch }, payload) {
            const APIkey = "AIzaSyD9ltrnynfbIopqN1BMFPHZ_DgUV9jZdh8";
        ...
        async getUser({ commit }, payload) {
            try {
                ...
                `https://vue-js-project-9795a-default-rtdb.firebaseio.com/user.json`
                );
